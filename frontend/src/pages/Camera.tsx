...
export default function Camera() {
  // live pushes over WS; seed with one REST read so the page isn't blank
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-sm text-neutral-500 mb-5">
        Live face tracking from the vision service.
      </p>
      ...
      {!cam?.running ? (
        ...
        <>
          ...
          {/* Frame viewport: face plotted at its normalized position */}
